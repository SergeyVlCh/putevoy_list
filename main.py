...
frame = Frame(window)
frame.grid(column=0, row=4, columnspan=2, pady=10, padx=10, sticky='nsew')
...
select_all_check = Checkbutton(inner_frame, text="Выбрать все", variable=select_all_var, command=select_all)
select_all_check.pack(fill='x', pady=5)
...
save_button.grid(column=0, row=5, columnspan=2, pady=10)
