...
# Функция для автоматического сохранения выбранного водителя
def on_driver_selected(event, gosnomer):
    selections[gosnomer] = combo_boxes[gosnomer].get()
...
for marka, gosnomer in autos:
    ...
    combo_driver.bind("<<ComboboxSelected>>", lambda event, gosnomer=gosnomer: on_driver_selected(event, gosnomer))
